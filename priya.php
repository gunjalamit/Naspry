...
<div class="row" style="overflow-y: scroll;background-color:#4d394b;height:700px;">
  <div class="col-sm-12" id="personaldiv" style="height:700px;">
    ...
    <div id="persoldiv" style="height:220px;">
      ...
      <div class="links users active-element"><a href="/lonar2-master/priya.php" class="bodyclr"><img src="assets/images/icon-inactive.png" height="15" width="15"/>&nbsp;priya</a></div>
      ...
      <div class="col-sm-8 col-lg-7">
              ...
              <div class="row">
                <div class="col-sm-7 col-lg-12" >
                  <div class="row">
                        <div class="col-sm-10">
                          <div class="chanelname" padding-left:5px><b>#priya</b></div>
